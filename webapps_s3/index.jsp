...
<section class="hero">
    <div class="container">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="https://hf-vpc-prd-s3.s3.ap-northeast-2.amazonaws.com/img/homepage/main.jpg">
                <div class="row">
                    <div class="col-lg-6">
            ...
            <div class="hero__items set-bg" data-setbg="https://hf-vpc-prd-s3.s3.ap-northeast-2.amazonaws.com/img/homepage/tving.jpg">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero__text">
            ...
            <div class="hero__items set-bg" data-setbg="https://hf-vpc-prd-s3.s3.ap-northeast-2.amazonaws.com/img/homepage/marvel.jpg">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero__text">
