...
<head>
    ...
    <link rel="icon" href="https://hf-vpc-prd-s3.s3.ap-northeast-2.amazonaws.com/img/data/join.png">
    <title>Join</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                 <div class="login__register">
                    <div class="product__item__pic set-bg" data-setbg="https://hf-vpc-prd-s3.s3.ap-northeast-2.amazonaws.com/img/contents/yumi.jpg">
                    </div>
                </div>
            </div>
        </div>
